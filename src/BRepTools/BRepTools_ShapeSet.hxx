...
public:
  ...
  Standard_EXPORT virtual void WriteGeometry (Standard_OStream& OS, Message_ProgressScope* thePS = 0L) Standard_OVERRIDE;
  
  //! Reads the geometry of me from the  stream  <IS>.
  Standard_EXPORT virtual void ReadGeometry (Standard_IStream& IS, Message_ProgressScope* thePS = 0L) Standard_OVERRIDE;
  ...
  //! from the  stream  <IS>.
  Standard_EXPORT void ReadPolygon3D (Standard_IStream& IS, Message_ProgressScope* thePS = 0L);
  ...
  //! from the  stream  <IS>.
  Standard_EXPORT void ReadTriangulation (Standard_IStream& IS, Message_ProgressScope* thePS = 0L);
  ...
  //! from the  stream  <IS>.
  Standard_EXPORT void ReadPolygonOnTriangulation (Standard_IStream& IS, Message_ProgressScope* thePS = 0L);
