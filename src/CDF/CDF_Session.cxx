...
//purpose  : 
//=======================================================================
const Standard_Boolean CDF_Session::FindApplication(const Standard_Integer theID, Handle(CDF_Application)& theApp) const
{
  if (myAppDirectory.IsBound(theID))
  {
...
//=======================================================================
const Standard_Boolean CDF_Session::RemoveApplication(const Standard_Integer theID)
{
  if (myAppDirectory.IsBound(theID))
  {
