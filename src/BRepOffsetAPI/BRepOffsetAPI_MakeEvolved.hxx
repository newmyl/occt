...
public:
  ...
  Standard_EXPORT BRepOffsetAPI_MakeEvolved(const TopoDS_Wire& theSpine,
                                            const TopoDS_Wire& theProfile,
                                            const GeomAbs_JoinType theJoinType,
                                            const Standard_Boolean theIsAxeProf,
                                            const Standard_Boolean theIsSolid,
                                            const Standard_Boolean theIsProfOnSpine,
  ...
  //! (theProfile) along the spine (theSpine).
  //! See description to this class for detailed information.
  Standard_EXPORT BRepOffsetAPI_MakeEvolved(const TopoDS_Face& theSpine,
                                            const TopoDS_Wire& theProfile,
                                            const GeomAbs_JoinType theJoinType,
                                            const Standard_Boolean theIsAxeProf,
                                            const Standard_Boolean theIsSolid,
