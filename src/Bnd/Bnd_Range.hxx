...
public:
  ...
  //!   *  theLambda == 0 --> MIN boundary was returned;
  //!   *  theLambda == 0.5 --> Middle point was returned;
  //!   *  theLambda == 1 --> MAX boundary was returned;
  //!   *  theLambda < 0 --> the value less than MIN was returned;
  //!   *  theLambda > 1 --> the value greater than MAX was returned.
  //! If <this> is VOID the method returns false.
