...
// 26-Mar-96 : xab : inclusion of too great inlines
// 15-Oct-96 : alr : extraction of inlines (not all included by xab)
// 19-Fev-97 : jct : add methods UVBox and UVConstraints (G1134)
// 10-Dec-97 : jag : Great debug on delete and method Copy...
// 13-Jan-98 : alr : add derivatives for constraints G3 and approx. C2
// 28-Avr-98 : alr : Take into account Linear*Constraint, methods SolveTI1,SolveTI2,SolveTI3
 ...
 void Plate_Plate::CoefPol(Handle(TColgp_HArray2OfXYZ)& Coefs) const
{
  ...
  for(Standard_Integer iv =0; iu+iv < order; iv++)
  {
    ...
    // it is necessary to reset this line if one remove factors in
    // method Polm.
    i++;
  }
...
Standard_Real Plate_Plate::SolEm(const gp_XY& point2d, const Standard_Integer iu, const Standard_Integer iv) const 
{
  ...
  // this expression takes a lop of time 
