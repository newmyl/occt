                                          ...
                                          Message_ProgressScope* theProgr)
{
  ...
  TopoDSToStep_Builder StepB(aFace, aTool, FP, theProgr);
                                          ...
                                          Message_ProgressScope* theProgr)
{
  ...
  TopoDSToStep_Tool    aTool(aMap, Standard_False);
  TopoDSToStep_Builder StepB(aShell, aTool, FP, theProgr);
  if (theProgr && !theProgr->More())
    return;
  //TopoDSToStep::AddResult ( FP, aTool );
                                          ...
                                          Message_ProgressScope* theProgr)
{
  ...
  for (It.Initialize(aSolid); It.More() && aPS.More(); It.Next(), aPS.Next())
  {
    if (It.Value().ShapeType() == TopAbs_SHELL) {
      aShell = TopoDS::Shell(It.Value());

      TopoDSToStep_Tool    aTool(aMap, Standard_False);
      TopoDSToStep_Builder StepB(aShell, aTool, FP, &aPS);
      TopoDSToStep::AddResult ( FP, aTool );
