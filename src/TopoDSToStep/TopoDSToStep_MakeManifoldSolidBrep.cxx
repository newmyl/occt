...
TopoDSToStep_MakeManifoldSolidBrep::
  TopoDSToStep_MakeManifoldSolidBrep(const TopoDS_Shell& aShell,
                                     ...
                                     Message_ProgressScope* theProgr)
{
  theManifoldSolidBrep = MakeManifoldSolidBrep(aShell, FP, theProgr);
  done = !theManifoldSolidBrep.IsNull();
  if (!done && (!theProgr || theProgr->More())) {
                                     ...
                                     Message_ProgressScope* theProgr)
{
  ...
  if (!aOuterShell.IsNull()) {
    ...
    theManifoldSolidBrep = MakeManifoldSolidBrep(aOuterShell, FP, theProgr);
    done = !theManifoldSolidBrep.IsNull();
    if (!done && (!theProgr || theProgr->More())) {
