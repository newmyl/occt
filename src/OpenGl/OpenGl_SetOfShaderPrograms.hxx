...
enum OpenGl_ProgramOptions
{
  ...
  OpenGl_PO_ShrinkMode    = 0x2000,  //!< shrunk triangulation display mode
  OpenGl_PO_SolidWFMode   = 0x4000,  //!< solid wireframe display mode
  OpenGl_PO_ColoringEdges = 0x8000,  //!< coloring edges status
  OpenGl_PO_HiddenLine    = 0x10000, //!< removed hidden lines display mode
  OpenGl_PO_NB            = 0x20000  //!< overall number of combinations
};
