   ...
   Message_ProgressScope* theProgr)
{
  ...
  theFP->Transfer (theMapper, theProgr);
   ...
   const Standard_Integer theModeTrans) const
{
  ...
  return TransferFinder
    (myAdaptorWrite,new Transfer_TransientMapper(theObj),theFP,theModel,theModeTrans, theProgr);
}
   ...
   const Standard_Integer modetrans) const
{
  ...
  IFSelect_ReturnStatus theReturnStat = TransferFinder
    (myAdaptorWrite,new TransferBRep_ShapeMapper(shape),FP,model,modetrans, theProgr);
